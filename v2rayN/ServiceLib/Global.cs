...
public class Global
{
    ...
    public static readonly List<string> GeoUrlBackups =
    [
        @"https://github.com/Loyalsoldier/v2ray-rules-dat/releases/latest/download/{0}.dat",
        @"https://cdn.jsdelivr.net/gh/Loyalsoldier/v2ray-rules-dat@release/{0}.dat",
        @"https://github.com/v2fly/domain-list-community/releases/latest/download/{0}.dat"
    ];

    public static readonly List<string> SingboxRulesetUrlBackups =
    [
        @"https://raw.githubusercontent.com/2dust/sing-box-rules/rule-set-{0}/{1}.srs",
        @"https://cdn.jsdelivr.net/gh/2dust/sing-box-rules@rule-set-{0}/{1}.srs"
    ];
    ...
    public static readonly Dictionary<ECoreType, string> CoreUrls = new()
        {
            ...
            { ECoreType.v2rayN, "tlkppm/v2rayN" },
        };
